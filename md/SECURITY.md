...
- **Bird (SMS/WhatsApp):** Geschäftsdaten-Hosting auf Google Cloud in NL/Belgien/UK/Deutschland — echte EU-Datenresidenz, kein US-Anbieter. Ersetzt Twilio (2026-09-03, dauerhaft ausgeschlossen — US-Anbieter, kompliziertes Setup, siehe `07-MODULE-CRM.md` Abschnitt 3). Verarbeitete Daten bleiben auf Telefonnummer + kurzen Nachrichtentext während des Versands beschränkt, keine dauerhafte Personendaten-Speicherung. Der jederzeit mögliche Teilwechsel (nur SMS, kein WhatsApp) auf den Schweizer Anbieter SMSup.ch bleibt dokumentiert in `07-MODULE-CRM.md` Abschnitt 3.
