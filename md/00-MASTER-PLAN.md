...
- **Twilio** (neu, 2026-08-18) — SMS-Versand (Buchungs-Reminder mit Opt-in, CRM-SMS-Alerts). Details/Abwägung gegenüber dem Schweizer Anbieter SMSup.ch in `07-MODULE-CRM.md` Abschnitt 3.
